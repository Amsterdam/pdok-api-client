...
class Response(BaseModel):
    ...
    num_found_exact: Optional[StrictBool] = Field(default=None, alias="numFoundExact")
    start: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["docs", "maxScore", "numFound", "numFoundExact", "start"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "numFoundExact": obj.get("numFoundExact"),
            "start": obj.get("start")
        })
        return _obj
