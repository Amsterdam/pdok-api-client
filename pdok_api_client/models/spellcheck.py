...
class Spellcheck(BaseModel):
    ...
    Spellcheck
    """ # noqa: E501
    collations: Optional[List[SpellcheckCollationsInner]] = None
    suggestions: Optional[List[SpellcheckSuggestionsInner]] = None
    __properties: ClassVar[List[str]] = ["collations", "suggestions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "collations": [SpellcheckCollationsInner.from_dict(_item) for _item in obj["collations"]] if obj.get("collations") is not None else None,
            "suggestions": [SpellcheckSuggestionsInner.from_dict(_item) for _item in obj["suggestions"]] if obj.get("suggestions") is not None else None
        })
        return _obj
