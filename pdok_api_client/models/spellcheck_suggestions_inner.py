...
SPELLCHECKSUGGESTIONSINNER_ONE_OF_SCHEMAS = ["SpellcheckSuggestionsInnerOneOf", "str"]

class SpellcheckSuggestionsInner(BaseModel):
    """
    SpellcheckSuggestionsInner
    """
    # data type: str
    oneof_schema_1_validator: Optional[StrictStr] = None
    # data type: SpellcheckSuggestionsInnerOneOf
    oneof_schema_2_validator: Optional[SpellcheckSuggestionsInnerOneOf] = None
    actual_instance: Optional[Union[SpellcheckSuggestionsInnerOneOf, str]] = None
    one_of_schemas: Set[str] = { "SpellcheckSuggestionsInnerOneOf", "str" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = SpellcheckSuggestionsInner.model_construct()
        error_messages = []
        match = 0
        ...
        # validate data type: SpellcheckSuggestionsInnerOneOf
        if not isinstance(v, SpellcheckSuggestionsInnerOneOf):
            error_messages.append(f"Error! Input type `{type(v)}` is not `SpellcheckSuggestionsInnerOneOf`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in SpellcheckSuggestionsInner with oneOf schemas: SpellcheckSuggestionsInnerOneOf, str. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in SpellcheckSuggestionsInner with oneOf schemas: SpellcheckSuggestionsInnerOneOf, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into SpellcheckSuggestionsInnerOneOf
        try:
            instance.actual_instance = SpellcheckSuggestionsInnerOneOf.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into SpellcheckSuggestionsInner with oneOf schemas: SpellcheckSuggestionsInnerOneOf, str. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into SpellcheckSuggestionsInner with oneOf schemas: SpellcheckSuggestionsInnerOneOf, str. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], SpellcheckSuggestionsInnerOneOf, str]]:
