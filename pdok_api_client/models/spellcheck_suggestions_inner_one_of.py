...
class SpellcheckSuggestionsInnerOneOf(BaseModel):
    """
    SpellcheckSuggestionsInnerOneOf
    """ # noqa: E501
    end_offset: Optional[StrictInt] = Field(default=None, alias="endOffset")
    num_found: Optional[StrictInt] = Field(default=None, alias="numFound")
    start_offset: Optional[StrictInt] = Field(default=None, alias="startOffset")
    suggestion: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["endOffset", "numFound", "startOffset", "suggestion"]
