...
class Suggest200Response(BaseModel):
    """
    Suggest200Response
    """ # noqa: E501
    highlighting: Optional[Dict[str, HighlightingValue]] = None
    response: Optional[Response] = None
    spellcheck: Optional[Spellcheck] = None
    __properties: ClassVar[List[str]] = ["highlighting", "response", "spellcheck"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each value in highlighting (dict)
        _field_dict = {}
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "highlighting": dict(
                (_k, HighlightingValue.from_dict(_v))
                for _k, _v in obj["highlighting"].items()
            )
            if obj.get("highlighting") is not None
            else None,
            "response": Response.from_dict(obj["response"]) if obj.get("response") is not None else None,
            "spellcheck": Spellcheck.from_dict(obj["spellcheck"]) if obj.get("spellcheck") is not None else None
        })
        return _obj
