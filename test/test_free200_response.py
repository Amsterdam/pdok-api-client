...
class TestFree200Response(unittest.TestCase):
    """Free200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Free200Response:
        """Test Free200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Free200Response`
        """
        model = Free200Response()
        if include_optional:
            return Free200Response(
