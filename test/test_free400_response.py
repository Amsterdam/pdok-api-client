...
class TestFree400Response(unittest.TestCase):
    """Free400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Free400Response:
        """Test Free400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Free400Response`
        """
        model = Free400Response()
        if include_optional:
            return Free400Response(
                error = pdok_api_client.models.error.error(
                    code = 400, 
                    metadata = [
                        'error-class'
                        ], 
