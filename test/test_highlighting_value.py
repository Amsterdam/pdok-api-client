...
class TestHighlightingValue(unittest.TestCase):
    """HighlightingValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HighlightingValue:
        """Test HighlightingValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HighlightingValue`
        """
        model = HighlightingValue()
        if include_optional:
    ...
    def testHighlightingValue(self):
        """Test HighlightingValue"""
