...
class TestLocatieserverApi(unittest.IsolatedAsyncioTestCase):
    """LocatieserverApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = LocatieserverApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_free(self) -> None:
        """Test case for free
    ...
    async def test_reverse_geocoder(self) -> None:
        """Test case for reverse_geocoder
