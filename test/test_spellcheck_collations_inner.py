...
class TestSpellcheckCollationsInner(unittest.TestCase):
    """SpellcheckCollationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpellcheckCollationsInner:
        """Test SpellcheckCollationsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpellcheckCollationsInner`
        """
        model = SpellcheckCollationsInner()
        if include_optional:
            return SpellcheckCollationsInner(
                collation_query = '',
                hits = 56,
    ...
    def testSpellcheckCollationsInner(self):
        """Test SpellcheckCollationsInner"""
