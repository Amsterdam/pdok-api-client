...
class TestSpellcheckCollationsInnerOneOf(unittest.TestCase):
    """SpellcheckCollationsInnerOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpellcheckCollationsInnerOneOf:
        """Test SpellcheckCollationsInnerOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpellcheckCollationsInnerOneOf`
        """
        model = SpellcheckCollationsInnerOneOf()
        if include_optional:
            return SpellcheckCollationsInnerOneOf(
                collation_query = '',
                hits = 56,
                misspellings_and_corrections = [
                    ''
                    ]
            )
        else:
    ...
    def testSpellcheckCollationsInnerOneOf(self):
        """Test SpellcheckCollationsInnerOneOf"""
