...
class TestSpellcheckSuggestionsInner(unittest.TestCase):
    """SpellcheckSuggestionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpellcheckSuggestionsInner:
        """Test SpellcheckSuggestionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpellcheckSuggestionsInner`
        """
        model = SpellcheckSuggestionsInner()
        if include_optional:
            return SpellcheckSuggestionsInner(
                end_offset = 56,
                num_found = 56,
                start_offset = 56,
                suggestion = [
    ...
    def testSpellcheckSuggestionsInner(self):
        """Test SpellcheckSuggestionsInner"""
