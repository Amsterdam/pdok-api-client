...
class TestSpellcheckSuggestionsInnerOneOf(unittest.TestCase):
    """SpellcheckSuggestionsInnerOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpellcheckSuggestionsInnerOneOf:
        """Test SpellcheckSuggestionsInnerOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpellcheckSuggestionsInnerOneOf`
        """
        model = SpellcheckSuggestionsInnerOneOf()
        if include_optional:
            return SpellcheckSuggestionsInnerOneOf(
                end_offset = 56,
                num_found = 56,
                start_offset = 56,
                suggestion = [
    ...
    def testSpellcheckSuggestionsInnerOneOf(self):
        """Test SpellcheckSuggestionsInnerOneOf"""
