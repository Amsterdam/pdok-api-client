...
class TestSuggest200Response(unittest.TestCase):
    """Suggest200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Suggest200Response:
        """Test Suggest200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Suggest200Response`
        """
        model = Suggest200Response()
        if include_optional:
            return Suggest200Response(
                highlighting = {
                    'key' : pdok_api_client.models.highlighting_value.highlighting_value(
                        suggest = [
                            ''
                            ], )
                    },
                response = pdok_api_client.models.response.response(
                    docs = [
                        None
                        ], 
                    max_score = 1.337, 
                    ...
                    start = 56, ),
                spellcheck = pdok_api_client.models.spellcheck.spellcheck(
                    collations = [
                        null
                        ], 
                    suggestions = [
    ...
    def testSuggest200Response(self):
        """Test Suggest200Response"""
